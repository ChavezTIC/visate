                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form class="signup-form" action="#" method="POST" role="form">
                        <div class="form-input-group">
                            <i class="fa fa-envelope"></i><input type="text" class="" placeholder="Ingresa tu E-mail" required>
                        </div>
                        <div class="form-input-group">
                            <i class="fa fa-lock"></i><input type="text" class="" placeholder="Ingresa tu ID de solicitud" required>
                        </div>
