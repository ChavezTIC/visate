...
class SolicitudController extends \BaseController {
	...
	public function index()
	{
		...
		$Compania->id = $Principal->id;
		$Compania->datos_principal_fk = $Principal->id;
		$Compania->save();
	...
	public function update()
	{
		...
		if(Request::ajax())
		{
			...
			if(($solicitud->ocupacion=='Ama de casa')||($solicitud->ocupacion=='Jubilado(a)')||($solicitud->ocupacion=='Pensionado(a)'))
			{
